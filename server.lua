...
QBCore.Commands.Add("givecar", "Bir Oyuncunun Datasına Araba Ver", {}, true, function(source, args)
	TriggerClientEvent("caycikaan:givecar", source)
end, "admin", "god")

QBCore.Functions.CreateCallback("caycikaan:givecar:check", function(source, cb, args)
...
RegisterServerEvent("giveCar", function(vehicleProps, vehiclemodel, vehicle)
	...
	exports.oxmysql:execute('INSERT INTO player_vehicles (license, citizenid, vehicle, hash, mods, plate, garage, state) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', { --Datayı Elleme
